...
import "./MyToken9FC20643.sol";

contract MyToken9FC20643PreSale {
    MyToken9FC20643 public token;
    ...
    function MyToken9FC20643PreSale(
        MyToken9FC20643 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken9FC20643(_token);
